package org.apache.cordova.photoviewer;
 ...
 * - Title
 */
public class CordovaPluginPhotoviewer extends CordovaPlugin {
    ...
    protected void launchActivity() throws JSONException {
        Intent i = new Intent(this.cordova.getActivity(), org.apache.cordova.photoviewer.PhotoActivity.class);
