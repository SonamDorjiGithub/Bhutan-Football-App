...
@Component({
  selector: 'app-futsal-changjiji',
  templateUrl: './futsal-changjiji.page.html',
  styleUrls: ['./futsal-changjiji.page.scss'],
})
export class FutsalChangjijiPage implements OnInit {
  ...
  loadFromFirestoreFutsalMonday(){
    this.fs.collection('/football').doc('changjiji_futsal').collection('/monday').get().subscribe(res=>  
      {
        res.forEach((doc:any)=>
      {
  ...
  loadFromFirestoreFutsalTuesday(){
    this.fs.collection('/football').doc('changjiji_futsal').collection('/tuesday').get().subscribe(res=>  
      {
        res.forEach((doc:any)=>
      {
  ...
  loadFromFirestoreFutsalWednesday(){
    this.fs.collection('/football').doc('changjiji_futsal').collection('/wednesday').get().subscribe(res=>  
      {
        res.forEach((doc:any)=>
      {
  ...
  loadFromFirestoreFutsalThursday(){
    this.fs.collection('/football').doc('changjiji_futsal').collection('/thursday').get().subscribe(res=>  
      {
        res.forEach((doc:any)=>
      {
  ...
  loadFromFirestoreFutsalFriday(){
    this.fs.collection('/football').doc('changjiji_futsal').collection('/friday').get().subscribe(res=>  
      {
        res.forEach((doc:any)=>
      {
  ...
  loadFromFirestoreFutsalSaturday(){
    this.fs.collection('/football').doc('changjiji_futsal').collection('/saturday').get().subscribe(res=>  
      {
        res.forEach((doc:any)=>
      {
  ...
  loadFromFirestoreFutsalSunday(){
    this.fs.collection('/football').doc('changjiji_futsal').collection('/sunday').get().subscribe(res=>  
      {
        res.forEach((doc:any)=>
      {
  ...
  loadPriceDetail(){
    this.fs.collection('/football').doc('changjiji_futsal').get().subscribe(res=>  
      {
