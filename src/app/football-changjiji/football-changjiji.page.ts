...
@Component({
  selector: 'app-football-changjiji',
  templateUrl: './football-changjiji.page.html',
  styleUrls: ['./football-changjiji.page.scss'],
})
export class FootballChangjijiPage implements OnInit {
  ...
  loadFromFirestoreMonday(){
    this.fs.collection('/football').doc('changjiji_full').collection('/monday').get().subscribe(res=>  
      {
        res.forEach((doc:any)=>
      {
  ...
  loadFromFirestoreTuesday(){
    this.fs.collection('/football').doc('changjiji_full').collection('/tuesday').get().subscribe(res=>  
      {
        res.forEach((doc:any)=>
      {
    ...
    loadFromFirestoreWednesday(){
      this.fs.collection('/football').doc('changjiji_full').collection('/wednesday').get().subscribe(res=>  
        {
          res.forEach((doc:any)=>
        {
    ...
    loadFromFirestoreThursday(){
      this.fs.collection('/football').doc('changjiji_full').collection('/thursday').get().subscribe(res=>  
        {
          res.forEach((doc:any)=>
        {
      ...
      loadFromFirestoreFriday(){
        this.fs.collection('/football').doc('changjiji_full').collection('/friday').get().subscribe(res=>  
          {
            res.forEach((doc:any)=>
          {
      ...
      loadFromFirestoreSaturday(){
        this.fs.collection('/football').doc('changjiji_full').collection('/saturday').get().subscribe(res=>  
          {
            res.forEach((doc:any)=>
          {
      ...
      loadFromFirestoreSunday(){
        this.fs.collection('/football').doc('changjiji_full').collection('/sunday').get().subscribe(res=>  
          {
            res.forEach((doc:any)=>
          {
  ...
  loadPriceDetail(){
    this.fs.collection('/football').doc('changjiji_full').get().subscribe(res=>  
      {
